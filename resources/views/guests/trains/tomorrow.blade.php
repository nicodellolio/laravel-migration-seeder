...
@section('content')
    <div class="container my-container my-5 bg-dark p-3">
        ...
        <div class="upper_container d-flex justify-content-between">
            <div class="mb-5 p-2 fs-1 text-decoration-underline">Trains departing tomorrow:</div>
            <div class="mb-5 p-3 fs-2 text-end time_box">Current date:<br>{{($now)}}</div>
        </div>
        ...
        <div class="back d-flex justify-content-evenly mt-5">
            ...
            <a class="btn btn-warning border-dark rounded-3 fw-light btn-sm fs-5 mt-5 p-3" href="{{route('guests.trains.today')}}" role="button">
                Today departures
            </a>
        </div>
    </div>
